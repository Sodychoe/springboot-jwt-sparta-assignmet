...
class JwtUtilTest {
  ...
  private static Stream<Arguments> invalidTokens() {
    ...
    return Stream.of(
        ...
        Arguments.arguments(tokens.get(2), SecurityErrorCode.INVALID_SIGNATURE.getMessage()),
        Arguments.arguments(tokens.get(3), SecurityErrorCode.ACCESS_TOKEN_EXPIRED.getMessage()),
        Arguments.arguments(tokens.get(4), SecurityErrorCode.EMPTY_TOKEN.getMessage())
    );
  }
